...
Listado.prototype.obtenerHorarios = function() {
    ...
    var contenedorArrayDeHorarios = [];
    //Recorremos el array de restaurantes y vamos agregando todos los array de horarios
    this.restaurantes.map(restaurante => contenedorArrayDeHorarios.push(restaurante.horarios));
    //En este arreglo vamos a poner todos los horarios, uno por uno
    var listaDeHorarios = [];
    contenedorArrayDeHorarios.forEach(function(arrayDeHorarios) {
        arrayDeHorarios.forEach(function(hora) {
            listaDeHorarios.push(hora)
        });
    });
    //En este arreglo vamos a poner todos los horarios pero sin repetidos
    var listaDeHorariosNoRepetidos = this.borrarElementoRepetido(listaDeHorarios);
    return listaDeHorariosNoRepetidos.sort();
}
